...
export default function Home() {
  ...
  const [messageState, setMessageState] = useState<{
    ...
    messages: [
      {
        message:
          'Xin chào tôi là Smart Shark, tôi sẽ giúp bạn trả lời các câu hỏi về các quy tắc, quy định của Trường ĐHBK TP HCM',
        type: 'apiMessage',
      },
    ],
    history: [],
  ...
  const [msgRecord, setMsgRecord] = useState<string>("")
    ...
    <>
      <Layout>
        ...
        <footer className="m-auto p-4">
          <a>Bản quyền thuộc Trường Đại học Bách Khoa - ĐHQG-HCM</a>
        </footer>
      </Layout>
    </>
  );
